...
import nuxt_plugin_plugin_75747de8 from 'nuxt_plugin_plugin_75747de8' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_9100b344 from 'nuxt_plugin_bootstrapvue_9100b344' // Source: .\\bootstrap-vue.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Colossus","titleTemplate":"%s || Colossus","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_75747de8 === 'function') {
    await nuxt_plugin_plugin_75747de8(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_9100b344 === 'function') {
    await nuxt_plugin_bootstrapvue_9100b344(app.context, inject)
  }
